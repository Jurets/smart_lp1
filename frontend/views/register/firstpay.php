...
<p id="shag-3-1-text" > <?php echo Yii::t('common', 'To activate your account, you must make the participation fee of $ '.$ammount_buff) ?></p>
...
<div>
    <input type="button" name="btn" id="btn_pay" class="btn-style-blue btn-style-blue-3-1" value="<?php echo Yii::t('common', 'PAY $ '.$ammount_buff) ?>" />
</div>
