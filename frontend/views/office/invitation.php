...
<div id="office-5-content">
    ...
    <a href="#"><input type="button" name="btn"  class="btn-style-green1" value="СКАЧАТЬ" /></a>
    <a href="#"><input type="button" name="btn"  class="btn-style-green2" value="ИНТЕРНЕТ РЕКЛАМА" /></a>
