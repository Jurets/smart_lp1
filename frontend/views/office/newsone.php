<div id="office3-content">
    <a href="/office/news/<?php echo $page ?>"><input type="button" name="btn"  class="btn-style-green" value="НАЗАД" /></a>
        ...
        <div id="office-3-1post1">
            ...
            <h4 class="office-3-miniZagolovok"><?php echo Yii::app()->dateFormatter->formatDateTime($model->activated, 'medium', null) .', '. Yii::app()->dateFormatter->formatDayInWeek('EEEE', array('wday'=>date('N', strtotime($model->activated))));?></h4>
