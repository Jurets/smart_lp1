...
<div id="wrapper">
    <div id="topLine">
        <ul id="nav">
            ...
            <li> <a href="/mp.pdf" target="_blank"> <?php echo strtoupper(BaseModule::t('common', 'OPPORTUNITIES')); ?> </a> </li>
            <li> <a href="/rules.just" target="_blank"> <?php echo BaseModule::t('common', 'RULES'); ?> </a> </li>
            <li> <a href="/vio.just" target="_blank"> <?php echo BaseModule::t('common', 'QUESTIONS AND ANSWERS'); ?>  </a> </li>
