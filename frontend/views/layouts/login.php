...
<?php echo CHtml::activeTextField($userLogin, 'username', array('class' => 'textbox1', 'id' => 'textbox1-login')); ?>
<?php echo $form->error($userLogin, 'username', array('style' => 'top: 15px;')); ?>

<p class="sub2" id="sub2-login"><?php echo Yii::t('common', 'PASSWORD') ?>:</p>
<?php echo CHtml::activePasswordField($userLogin, 'password', array('class' => 'textbox2', 'id' => 'textbox2-login')); ?>
...
<?php echo CHtml::activeTextField($userLogin, 'verifyCode', array('class' => 'textbox3', 'id' => 'textbox3-login')); ?>
