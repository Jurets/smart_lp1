...
//			),
	 ...
	 * @return Mpversions the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=Mpversions::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param Mpversions $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='mpversions-form')
		{
