...
<div class="form">
    ...
    <table>
            ...
            <tr><div class="copy">
            <td id="mr"><span class="mr"><?php echo Yii::t('rec',  Mathparams::$parameters[$key]) ; ?></span></td>
            <td><?php echo $form->hiddenField($mathparam, 'name', array('name'=>'Mathparams[name][]', 'id'=>false, 'readonly'=>"readonly")); ?>
            ...
            <?php echo $form->hiddenField($mathparam, 'id', array('name'=>'Mathparams[id][]', 'id'=>false)); ?></td>
            <div></div>
            </div></tr>
        <?php } ?>
    </table>
    ...
    <table border="0">
            <tr><div class="copy">
                <td id="mr"><span class="mr"><?php echo Yii::t('rec',  Mathparams::$parameters[0]); ?></span></td>
        ...
        <?php echo TbHtml::submitButton($model->isNewRecord ? Yii::t('rec','Edit') : Yii::t('rec','Edit'),array(
