...
<p><?php echo BaseModule::t('rec', "You may optionally enter a comparison operator") ."( <, <=, >, >=, <> or = )". BaseModule::t('rec', 'at the beginning of each of your search values to specify how the comparison should be done.'); ?></p>
