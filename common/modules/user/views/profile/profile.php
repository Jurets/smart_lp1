<?php $this->pageTitle=Yii::app()->name . ' - '.BaseModule::t('rec',"Profile");
...
?><h1><?php echo BaseModule::t('rec','Your profile'); ?></h1>
...
<table class="dataGrid">
	...
	<?php 
		...
		if ($profileFields) {
			...
			?>
	<tr>
		<th class="label"><?php echo CHtml::encode(BaseModule::t('rec',$field->title)); ?></th>
