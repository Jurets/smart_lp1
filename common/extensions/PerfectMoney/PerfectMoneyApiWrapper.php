<?php
    ...
    class PerfectMoneyApiWrapper extends CComponent {
        ...
        public $testMode = false;  //Вкл/Выкл тестового режима (средства реально не перемещаются)
        ...
        public function dataProcess(){ 
            ...
            // после всех действий сбрасываем входящие данные структуры API в исходное состояние
            $this->dataFlush();
        }
        ...
        protected function API_analyse(){  
            if(isset($this->outputStructure['ERROR'])){ // Стандарт API PM по возврату ошибок
